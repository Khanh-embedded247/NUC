/*********************************************************************
đăng ký các loại gói tin và ánh xạ chúng với hàm tạo tương ứng. Các hàm này giúp xác định xem một gói tin từ VESC có hợp lệ hay không 
và tạo đối tượng tương ứng để xử lý dữ liệu từ gói tin đó.
 ********************************************************************/
