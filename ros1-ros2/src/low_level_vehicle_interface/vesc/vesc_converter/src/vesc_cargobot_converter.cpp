 ...
 */
 ...
 /*
    1 round : 9s
 */
//kết nối với các bộ điều khiển xe điện và bánh xe, chuyển đổi giữa các dữ liệu tốc độ, encoder và 
//lệnh điều khiển (chu kỳ nhiệt).
...
#define RR_MOTOR_CALIB 1.1400//bánh xe phải sau
#define SIDEWAY_CALIB 1.1000//bánh xe phải trước
#define VEL_TO_DUTY 0.35//tỉ lệ chuyển đổi từ vận tốc thành duty_cycle
